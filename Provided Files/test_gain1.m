function [sol, val, correct_rate] = test_gain(sol,options)
...
cond_data(:,1)=test_data';
cond_data_train(:,1)=train_data';
% variable 2
load(['data\condition_data\' var2]);
cond_data(:,2)=test_data';
cond_data_train(:,2)=train_data';

% varible 3
load(['data\condition_data\' var3]);
cond_data(:,3)=test_data';
cond_data_train(:,3)=train_data';

all_cond=decision_test1(b,cond_data,cond_data_train);
...
function all_cond=decision_test1(b,cond_data,cond_data_train)
% this function 
